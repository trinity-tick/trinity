...
> 基于源码盘点（526 Python 文件 / 147 API 路由）+ 全量实测（626 passed / 43 skipped）
...
| 测试 | 626 passed / 43 skipped / 0 failed |
| 数据 | 记忆 11,782 · 实体 11,151 · 关系 28,340+12,116 · 审计 6,535 |
| 服务 | api :8001 · mcp :8000/:8003 · gateway :8002 · dashboard :3005 · PG :5430 |
| 最近新增 | B3 治理层 / B5 存储加密 / A4 跨模态 / 写路径 LLM 事实抽取 / edge bi-temporal |
